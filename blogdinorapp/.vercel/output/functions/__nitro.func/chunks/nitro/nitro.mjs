...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "922d2e54-6d79-4c78-ba11-1278e7394359",
  ...
  "public": {
    "apiBase": "https://bigfive.dev/blogdinor",
    "wordpress": {
      "apiBase": "https://bigfive.dev/blogdinor"
    }
  },
...
const _75vxU8 = lazyEventHandler(() => {
...
const _lazy_IB_SGk = () => import('../routes/api/articles.mjs');
const _lazy_I8Q4Bq = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/articles', handler: _lazy_IB_SGk, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_I8Q4Bq, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _75vxU8, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_I8Q4Bq, lazy: true, middleware: false, method: undefined }
];
...
export { encodeParam as A, parseQuery as B, withTrailingSlash as C, withoutTrailingSlash as D, listener as E, getResponseStatus as a, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, defineRenderHandler as e, getQuery as f, getResponseStatusText as g, getRouteRules as h, useNitroApp as i, createHooks as j, getContext as k, createRouter$1 as l, defu as m, hasProtocol as n, joinURL as o, publicAssetsURL as p, isScriptProtocol as q, executeAsync as r, sanitizeStatusCode as s, toRouteMatcher as t, useRuntimeConfig as u, getRequestURL as v, withQuery as w, withLeadingSlash as x, parseURL as y, encodePath as z };
