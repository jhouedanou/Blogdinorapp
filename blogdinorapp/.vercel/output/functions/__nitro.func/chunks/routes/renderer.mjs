...
const appHead = {"meta":[{"name":"description","content":"Blog officiel de Dinor App avec des articles sur la cuisine, les recettes et plus encore."},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Blog de Dinor App"};
